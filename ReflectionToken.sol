...
contract TokenContract is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    uint256 private _tTotal = 777 ether; // 777 total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Cryptosyno"; // token name
    string private _symbol = "CASYNO"; // token ticker
    ...
    address public slotMachine = 0x03AA1cf0097041Df7Ee901518697bEDde21CCaB5; // Slot Machine wallet address
    ...
    uint256 public minTokenToSwap = _tTotal/1000; // 0.01 will trigger the swap and add liquidity
    ...
    uint256 public burnFee = 50; // 5% will go to the burn address
    ...
    //     uint256 _slotMachineFee,
    //     uint256 _burnFee
    // ) external onlyOwner {
    //     redistributionFeeOnSelling = _redistributionFee;
    //     slotMachineFeeOnSelling = _slotMachineFee;
    //     burnFeeOnSelling = _burnFee;
    //     require(
    //         redistributionFeeOnSelling
    //             .add(slotMachineFeeOnSelling)
    //             .add(burnFeeOnSelling) <= maxFee,
    ...
    //     slotMachineFee = _slotMachineFee;
    //     burnFee = _burnFee;
    //     require(
    //         redistributionFee.add(slotMachineFee).add(
    //             burnFee
    //         ) <= maxFee,
    //         "BEP20: Can not be greater than max fee"
    //     );
